...
🛑 **Пропущенные звонки и голосовые сообщения уходят только на email** и нигде не учитываются (в `miss_call_*` адрес РОПа с опечаткой `rop@antydiolg.ru` — эти письма не доходят). Очевидный кандидат на перенос в CRM.
