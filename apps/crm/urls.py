...
urlpatterns = [
    ...
    path("clients/<uuid:client_id>/whatsapp/template/", views.whatsapp_template_picker, name="whatsapp_template_picker"),
    path("clients/<uuid:client_id>/whatsapp/template/send/", views.whatsapp_send_template, name="whatsapp_send_template"),
    path("clients/<uuid:client_id>/chat/template/send/", views.chat_send_template, name="chat_send_template"),
    path("clients/<uuid:client_id>/edit/", views.client_edit, name="client_edit"),
    path("clients/<uuid:client_id>/merge/", views.client_merge_modal, name="client_merge_modal"),
    path("clients/<uuid:client_id>/merge/search/", views.client_merge_search, name="client_merge_search"),
    path("clients/<uuid:client_id>/merge/compare/", views.client_merge_compare, name="client_merge_compare"),
    path("clients/<uuid:client_id>/merge/execute/", views.client_merge_execute, name="client_merge_execute"),
    ...
    path("clients/dedup-check/", views.client_dedup_check, name="client_dedup_check"),
