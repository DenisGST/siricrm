...
MAP = {
    ...
    # Тоже свой шаблон вместо общего: у УФССП просительная часть — окончить
    # исполнительные производства и вернуть листы ФУ (02.09.2026).
    "Требование об окончании ИП в УФССП.docx": (
        "req_ufssp_info", "Требование об окончании исполнительных производств в УФССП"),
}
...
# 🛑 Росреестр (29.08.2026) и УФССП (02.09.2026) отсюда УБРАНЫ — у них свои
# шаблоны (см. MAP выше): Росреестру нужна просительная часть про запрет сделок
# с недвижимостью, УФССП — про окончание исполнительных производств.
ALSO_BIND = {
