...
urlpatterns = [
    ...
    path("service/<uuid:service_id>/iskotpravlen/modal/", views.iskotpravlen_modal, name="iskotpravlen_modal"),
    ...
    path("case/<uuid:case_id>/abort/", views.case_run_abort, name="case_run_abort"),
