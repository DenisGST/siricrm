...
Авто-привязка эквайринга по телефону/`OrderId` (сейчас всё вручную), оплата прямо из чата клиента
(кнопка → Init с OrderId=client/service → ссылка в TG/WA/MAX), механика «Банк»-вкладки под загрузку
файловых выписок, бизнес-логика клиентских уведомлений об оплате.
